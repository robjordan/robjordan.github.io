...
The fix was successful. BASIC loads just fine, and I celebrated with the obligatory 10 PRINT "HELLO WORLD". Thanks to Tezza for the original guide and to the [Vintage Computer Federation](http://www.vcfed.org/) for resources and help, especially ROM archives.
